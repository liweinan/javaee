 ...
 This will deploy two artifacts, target/javaee.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/javaee.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/javaee.war

 To undeploy the application, run:

  ./asadmin undeploy javaee
